...
RSpec.describe 'Post', type: :request do
  describe 'GET /index' do
    ...
    it 'displays a list of all posts' do
      ...
      expect(response.body).to include('All the list of post for users is avalible here.')
    end
  ...
  describe 'GET /show' do
    ...
    it "displays the post's title and body" do
      get '/users/1/posts/1'
      expect(response).to be_successful
      expect(response.body).to include('All the post from users are avalible here.</')
    end
